...
export default function UpdateVisit(props) {
    ...
    const handleSubmit = () => {
        const rootRef = firebase.database().ref('patients').child(props.patientId).child('visits').child(props.visitId);
        rootRef.update({
    ...
    return (
        <div>
            <Tooltip TransitionComponent={Zoom} title="Edytuj wizytę">
                <Button
                    variant="contained"
                    color="secondary"
                    size="small"
            ...
            <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title" maxWidth='lg' fullWidth={true} disableEscapeKeyDown={true} disableBackdropClick={true}>
                <AppBar position="static">
                    <Toolbar variant="regular">
                        ...
                        <Typography variant="h6" color="inherit">Edycja wizyty</Typography>
                    </Toolbar>
                </AppBar>
                <DialogContent>
                    <TextField
                        name="consultation"
                        defaultValue={props.consultation}
                                    ...
                                    <Alert icon={false} severity="info">
                                        {(part.name === 'ilium'
                                            ...
                                            <TextField
                                                ...
                                                variant="outlined"
                                                type="text"
                                                defaultValue={manualTest[part.name].description ? manualTest[part.name].description : ''}
                                                fullWidth />
                                        }
